...
insert into  `terraform-demo-471803.trips_data_all.yellow_tripdata` 
SELECT * FROM `bigquery-public-data.new_york_taxi_trips.tlc_yellow_trips_2020`; 

  -- Fixes yellow table schema
ALTER TABLE `terraform-demo-471803.trips_data_all.yellow_tripdata`
...
ALTER TABLE `terraform-demo-471803.trips_data_all.green_tripdata`
  RENAME COLUMN vendor_id TO VendorID;
ALTER TABLE `terraform-demo-471803.trips_data_all.green_tripdata`
